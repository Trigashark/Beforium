...
{
	public class Bubblebathp : ModProjectile
	{
			...
			if (projectile.frameCounter >= 30)
			{
				...
				if (num2 != -1)
				{
					...
					if (flag)
					{
						...
						value *= num5;
						int p = Terraria.Projectile.NewProjectile(projectile.Center.X, projectile.Center.Y, value.X, value.Y, ProjectileID.Bubble, 5, projectile.knockBack / 2f, projectile.owner, 0f, 0f);
