...
{
	internal class ShellHook : ModItem
	{
		public override void SetStaticDefaults()
		{
			DisplayName.SetDefault("Shell Hook");
		}
		...
		public override void SetDefaults()
		{
			...
			*/
			...
			item.shoot = ModContent.ProjectileType<ShellHookProjectile>();
		}
	}

	internal class ShellHookProjectile : ModProjectile
	{
		public override void SetStaticDefaults()
		{
		...
		public override bool PreDraw(SpriteBatch spriteBatch, Color lightColor)
		{
			...
			while (distance > 30f && !float.IsNaN(distance))
			{
				...
				//Draw chain
				spriteBatch.Draw(mod.GetTexture("Items/ShellHookChain"), new Vector2(center.X - Main.screenPosition.X, center.Y - Main.screenPosition.Y),
